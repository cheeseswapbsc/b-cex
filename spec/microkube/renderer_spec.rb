require 'ndax/renderer'

describe Ndax::Renderer do
  let(:renderer) { Ndax::Renderer.new }
  ...
  let(:config) do
    {
      ...
      'images' => {
        'peatio' => 'ndexnetwork/peatio:2.1.20',
        'barong' => 'ndexnetwork/barong:2.1.4',
        'frontend' => 'ndexnetwork/frontend:2.1.0',
        'tower' => 'ndexnetwork/tower:0.1.17'
      },
      'vendor' => {
        'frontend' => 'https://github.com/nexbitio/mikroapp.git'
      }
    }
  end
